...
class stock_production_lot(models.Model):
    ...
    lic_create_date = fields.Datetime('Licence Creation Date')
    lic_create_user = fields.Integer('Licence Create User ID')
    lic_cancel_date = fields.Datetime('Licence Cancellation Date')
    lic_cancel_user = fields.Integer('Licence Cancel User ID')
    lic_modify_date = fields.Datetime('Licence Modification Date')
